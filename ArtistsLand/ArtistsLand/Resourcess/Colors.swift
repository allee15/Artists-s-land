...
extension Color {
    ...
    static let pink1Custom = Color(.pink1)
    static let pink2Custom = Color(.pink2)
    static let pink3Custom = Color(.pink3)
    static let pink4Custom = Color(.pink4)
    static let pink5Custom = Color(.pink5)
    static let lightPinkCustom = Color(.lightPink)
